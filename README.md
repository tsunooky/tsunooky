...
Inspired by my personal Arch Linux setup, Epidots provides a modern workflow with terminal auto-completion, a custom status bar, and dynamic color theming from wallpaper colors.
...
### [💠 Arch Linux Dotfiles](https://github.com/tsunooky/dotfiles)
Personal Arch Linux configuration using **i3wm** and **matugen**.
One-command installation to run just after a fresh Arch Linux install.
